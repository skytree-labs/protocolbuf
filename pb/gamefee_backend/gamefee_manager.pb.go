...
type ExchangeRequest struct {
	...
	PointAmount string       `protobuf:"bytes,2,opt,name=point_amount,json=pointAmount,proto3" json:"point_amount,omitempty"`
...
func (x *ExchangeRequest) GetTokenAmount() string {
	if x != nil {
...
func (x *ExchangeRequest) GetPointAmount() string {
	if x != nil {
...
func (x *ExchangeRequest) GetRate() string {
	if x != nil {
		return x.Rate
	}
	return ""
...
func (x *OnTokenExchangedRequest) GetPointAmount() string {
	if x != nil {
		return x.PointAmount
	}
	return ""
...
func (x *OnTokenExchangedRequest) GetRate() string {
	if x != nil {
		return x.Rate
	}
	return ""
...
var file_gamefee_manager_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12,
	0x0a, 0x04, 0x72, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x61,
	...
	0x69, 0x6e, 0x74, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
