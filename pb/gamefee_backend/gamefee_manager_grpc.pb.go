...
type GameFeeManagerClient interface {
	...
	GetFeeDecimal(ctx context.Context, in *GetFeeDecimalRequest, opts ...grpc.CallOption) (*GetFeeDecimalResponse, error)
}
...
func (c *gameFeeManagerClient) GetFeeDecimal(ctx context.Context, in *GetFeeDecimalRequest, opts ...grpc.CallOption) (*GetFeeDecimalResponse, error) {
	out := new(GetFeeDecimalResponse)
	err := c.cc.Invoke(ctx, "/gamefee_manager.api.GameFeeManager/GetFeeDecimal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GameFeeManagerServer interface {
	...
	GetFeeDecimal(context.Context, *GetFeeDecimalRequest) (*GetFeeDecimalResponse, error)
...
func (UnimplementedGameFeeManagerServer) GetFeeDecimal(context.Context, *GetFeeDecimalRequest) (*GetFeeDecimalResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFeeDecimal not implemented")
}
...
func _GameFeeManager_GetFeeDecimal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFeeDecimalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameFeeManagerServer).GetFeeDecimal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gamefee_manager.api.GameFeeManager/GetFeeDecimal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameFeeManagerServer).GetFeeDecimal(ctx, req.(*GetFeeDecimalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GameFeeManager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFeeDecimal",
			Handler:    _GameFeeManager_GetFeeDecimal_Handler,
		},
	},
